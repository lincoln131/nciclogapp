...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { coworker: @incident.coworker, date: @incident.date, description: @incident.description } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { coworker: @incident.coworker, date: @incident.date, description: @incident.description } }
