class StolenVehicle < ApplicationRecord
    validates :oca, :operator_name, :officer_name, :ncic_num, :year, :make, :model, :vin, :license_plate, :color, :owner_name, :owner_phone, :date_add, presence: true
    ...
    validates :oca, format: {with: /(\A([0-9]{1}[0-9]{1}-{1}[0]{1}[0-6]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1})\z)|(\A\z)/, message:" - YY-NNNNNN"}
