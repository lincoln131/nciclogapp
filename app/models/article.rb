class Article < ApplicationRecord
    ...
    before_validation :date_format_dash_to_slash, :check_previous_value
    ...
    private
        def check_previous_value
        field_names = [oca,operator_name,officer_name,ncic_num,make,model,serial,description,owner_name,owner_phone,date_add,date_remove,remove_by]
    ...
    validates :oca,:operator_name,:officer_name,:ncic_num,:make,:model,:serial,:description,:owner_name,:owner_phone,:date_add, presence: true
